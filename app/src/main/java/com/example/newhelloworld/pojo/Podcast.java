...
//    }
    ...
    public Podcast(Integer podcastId, Integer albumId, Integer duration, String title, String podcastPoster, String podcastPath, Integer views, Integer commentNum, Integer likeNum, Integer uploaderId, String uploaderName, String createTime, String updateTime) {
        this.podcastId = podcastId;
        this.albumId = albumId;
        this.duration = duration;
        this.title = title;
